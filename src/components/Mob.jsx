...
const Mob = () => {
	...
	const journeyPathDetails = [
		...
		{ id: 2, x1: "50%", y1: "30vh", x2: "10%", y2: "30vh", duration: 0.2, delay: 1 },
		{ id: 3, x1: "50%", y1: "30vh", x2: "90%", y2: "30vh", duration: 0.2, delay: 1 },
		{ id: 4, x1: "10%", y1: "30vh", x2: "10%", y2: "40vh", duration: 0.2, delay: 1.2 },
		{ id: 5, x1: "90%", y1: "30vh", x2: "90%", y2: "40vh", duration: 0.2, delay: 1.4 },
		{ id: 6, x1: "10%", y1: "40vh", x2: "50%", y2: "40vh", duration: 0.2, delay: 1.6 },
		{ id: 7, x1: "90%", y1: "40vh", x2: "50%", y2: "40vh", duration: 0.2, delay: 1.6 },
		{ id: 8, x1: "50%", y1: "40vh", x2: "50%", y2: "60vh", duration: 0.2, delay: 1.8 },
		{ id: 9, x1: "50%", y1: "60vh", x2: "10%", y2: "60vh", duration: 0.2, delay: 2 },
		{ id: 10, x1: "10%", y1: "60vh", x2: "10%", y2: "80vh", duration: 0.2, delay: 2.2 },
		{ id: 11, x1: "10%", y1: "80vh", x2: "90%", y2: "80vh", duration: 0.2, delay: 2.4 },
		{ id: 12, x1: "90%", y1: "80vh", x2: "90%", y2: "100vh", duration: 0.2, delay: 2.6 },
		{ id: 13, x1: "90%", y1: "100vh", x2: "10%", y2: "100vh", duration: 0.2, delay: 2.8 },
		{ id: 14, x1: "10%", y1: "100vh", x2: "10%", y2: "115vh", duration: 0.2, delay: 3 },
		{ id: 15, x1: "10%", y1: "115vh", x2: "50%", y2: "115vh", duration: 0.2, delay: 3.2 },
		{ id: 16, x1: "50%", y1: "115vh", x2: "50%", y2: "125vh", duration: 0.2, delay: 3.4 },
		{ id: 17, x1: "50%", y1: "125vh", x2: "10%", y2: "125vh", duration: 0.2, delay: 3.6 },
		{ id: 18, x1: "50%", y1: "125vh", x2: "90%", y2: "125vh", duration: 0.2, delay: 3.6 },
		{ id: 19, x1: "10%", y1: "125vh", x2: "10%", y2: "175vh", duration: 0.2, delay: 3.8 },
		{ id: 20, x1: "90%", y1: "125vh", x2: "90%", y2: "175vh", duration: 0.2, delay: 3.8 },
		{ id: 21, x1: "10%", y1: "175vh", x2: "50%", y2: "175vh", duration: 0.2, delay: 4 },
		{ id: 22, x1: "90%", y1: "175vh", x2: "50%", y2: "175vh", duration: 0.2, delay: 4 },
		{ id: 23, x1: "50%", y1: "175vh", x2: "50%", y2: "185vh", duration: 0.2, delay: 4.2 },
		{ id: 24, x1: "30%", y1: "185vh", x2: "50%", y2: "185vh", duration: 0.2, delay: 4.4 },
		{ id: 25, x1: "30%", y1: "185vh", x2: "30%", y2: "200vh", duration: 0.2, delay: 4.6 },
		{ id: 26, x1: "30%", y1: "200vh", x2: "70%", y2: "200vh", duration: 0.2, delay: 4.8 },
		{ id: 27, x1: "70%", y1: "200vh", x2: "70%", y2: "215vh", duration: 0.2, delay: 5 },
		{ id: 28, x1: "70%", y1: "215vh", x2: "50%", y2: "215vh", duration: 0.2, delay: 5.2 },
		{ id: 29, x1: "50%", y1: "215vh", x2: "50%", y2: "225vh", duration: 0.2, delay: 5.4 },
		{ id: 30, x1: "50%", y1: "225vh", x2: "10%", y2: "225vh", duration: 0.2, delay: 5.6 },
		{ id: 31, x1: "50%", y1: "225vh", x2: "90%", y2: "225vh", duration: 0.2, delay: 5.6 },
		{ id: 32, x1: "10%", y1: "225vh", x2: "10%", y2: "280vh", duration: 0.2, delay: 5.8 },
		{ id: 33, x1: "90%", y1: "225vh", x2: "90%", y2: "280vh", duration: 0.2, delay: 5.8 },
		{ id: 34, x1: "10%", y1: "280vh", x2: "50%", y2: "280vh", duration: 0.2, delay: 6 },
		{ id: 35, x1: "90%", y1: "280vh", x2: "50%", y2: "280vh", duration: 0.2, delay: 6 },
		{ id: 36, x1: "50%", y1: "280vh", x2: "50%", y2: "295vh", duration: 0.2, delay: 6.2 },
		{ id: 37, x1: "50%", y1: "295vh", x2: "25%", y2: "295vh", duration: 0.2, delay: 6.4 },
		{ id: 38, x1: "25%", y1: "295vh", x2: "25%", y2: "315vh", duration: 0.2, delay: 6.6 },
		{ id: 39, x1: "25%", y1: "315vh", x2: "90%", y2: "315vh", duration: 0.2, delay: 6.8 },
		{ id: 40, x1: "90%", y1: "315vh", x2: "90%", y2: "350vh", duration: 0.2, delay: 7 },
		{ id: 41, x1: "90%", y1: "350vh", x2: "10%", y2: "350vh", duration: 0.2, delay: 7.2 },
		{ id: 42, x1: "10%", y1: "350vh", x2: "10%", y2: "360vh", duration: 0.2, delay: 7.4 },
		{ id: 43, x1: "10%", y1: "360vh", x2: "50%", y2: "360vh", duration: 0.2, delay: 7.6 },
		{ id: 44, x1: "50%", y1: "360vh", x2: "50%", y2: "365vh", duration: 0.2, delay: 7.8 },
		{ id: 45, x1: "50%", y1: "365vh", x2: "10%", y2: "365vh", duration: 0.2, delay: 8 },
		{ id: 46, x1: "50%", y1: "365vh", x2: "90%", y2: "365vh", duration: 0.2, delay: 8 },
		{ id: 47, x1: "10%", y1: "365vh", x2: "10%", y2: "400vh", duration: 0.2, delay: 8.2 },
		{ id: 48, x1: "90%", y1: "365vh", x2: "90%", y2: "400vh", duration: 0.2, delay: 8.2 },
		{ id: 49, x1: "10%", y1: "400vh", x2: "60%", y2: "400vh", duration: 0.2, delay: 8.4 },
		{ id: 50, x1: "90%", y1: "400vh", x2: "60%", y2: "400vh", duration: 0.2, delay: 8.4 },
		{ id: 51, x1: "60%", y1: "400vh", x2: "60%", y2: "415vh", duration: 0.2, delay: 8.6 },

...
const Tooltip = ({ children, tooltipTitle, tooltipText, show, position = "top", onClick }) => {
    ...
    return (
        <div className={`${children ? "relative inline-block group" : ""}`} onClick={onClick}>
            ...
            {(show || children) && (
                ...
                //     </div>
                // </div>
                <div className={`absolute  invisible opacity-0 group-hover:visible group-hover:opacity-100 ${positionClasses[position]} mb-3 w-72 transition-all duration-300 ease-out transform group-hover:translate-y-0 translate-y-2`}>
